...
class Visit(Base):
    ...
    report_images = relationship("VisitReportsImages", back_populates="visit")  # ✅ Added
    bill_info = relationship("BillInfo", back_populates="visit", uselist=False)




class VisitReportsImages(Base):
    __tablename__ = "visit_reports_images"   # ✅ Snake case with underscores
    ...
    visit = relationship("Visit", back_populates="report_images")  # ✅ Recommended
